package com.gw.stupid.listener.event;

import com.gw.stupid.listener.StupidApplicationRunListener;
import com.gw.stupid.listener.impl.StartingStupidAppRunListener;
...
public class StupidApplicationBootListener implements SpringApplicationRunListener, Ordered {
    ...
    private List<StupidApplicationRunListener> listeners;
